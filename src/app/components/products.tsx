  ...
  const products = [
    {
      ...
      description:
        "High-precision deep drawn metal components for industrial applications",
    ...
    },
    {
      ...
      image: "/assets/images/133096bd7fba0a46a6d4c044db475c15.gif",
      description:
        "Precision stamped sheet metal parts with exceptional accuracy",
    ...
    },
    {
      ...
      image: "/assets/images/133096bd7fba0a46a6d4c044db475c15.gif",
      description:
        "Durable metal end caps designed for optimal filtration performance",
    ...
    },
    {
      ...
      image: "/assets/images/133096bd7fba0a46a6d4c044db475c15.gif",
      description:
        "Complete housing solutions for filter systems and assemblies",
    ...
    },
    {
      ...
      image: "/assets/images/133096bd7fba0a46a6d4c044db475c15.gif",
      description:
        "Professional-grade frames for HEPA and panel filter systems",
      ...
      <div className="max-w-7xl mx-auto px-1 md:px-2 lg:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {products.map((product, index) => (
            <div
              key={product.id}
              className={`group relative bg-white rounded-3xl shadow-md hover:shadow-lg transition-all duration-500 transform hover:-translate-y-2 cursor-pointer overflow-hidden ${
            ...
            >
              ...
              <div className="relative p-6 md:p-8 h-full flex flex-col">
                ...
                <div className="flex-grow flex items-end">
                  <p
                    className={`text-sm text-slate-700 text-center leading-relaxed transition-all duration-300 normal-case ${
