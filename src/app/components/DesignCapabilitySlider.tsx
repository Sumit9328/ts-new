...
const slides = [
  {
    ...
    description:
      "Advanced curved pipe and component modeling with precision engineering",
  ...
  },
  {
    ...
    description:
      "Detailed technical drawings and specifications for manufacturing",
  ...
  },
  {
    ...
    description:
      "Precision cylindrical parts with complex geometries and tolerances",
  ...
  },
  {
    ...
    description:
      "Complete mechanical assembly designs with detailed part specifications",
  ...
  },
  {
    ...
    description:
      "Heavy-duty industrial components designed for maximum durability",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base md:text-lg text-slate-600 max-w-4xl mx-auto leading-relaxed normal-case">
            We offer complete reverse engineering services to provide part
            customisation, out-of-production replacement parts, casting molds, &
            more. We can produce 3D models, 2D drawings, Part technical Details
            and other Drafting services.
          </p>
        </div>
        ...
        >
          {slides.map((slide) => (
            <SplideSlide key={slide.id}>
              <div
                className={`${slide.bgColor} rounded-2xl shadow-md hover:shadow-lg transition-all duration-500 transform hover:-translate-y-2 cursor-pointer overflow-hidden h-96 group`}
              >
